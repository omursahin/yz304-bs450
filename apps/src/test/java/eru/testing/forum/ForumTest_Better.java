...
public class ForumTest_Better {
    ...
    public void shouldComputeMostProlificPoster() {
        ...
        Forum forum = new Forum();
        registerUserWithUsernameAndUniqueEmailAddress(forum, "billy", "b.sharp@@erciyes.edu.tr");
        registerUserWithUsernameAndUniqueEmailAddress(forum, "bash", "c.basham@erciyes.edu.tr");
    ...
    public void shouldNotRegisterEmailAddressThatAlreadyExists() {
        ...
        assertThrows(EmailAddressAlreadyExistsException.class, () -> {
            forum.registerUser("doesn't matter", "doesn't matter", "b.sharp@erciyes.edu.tr");
        });
    }
