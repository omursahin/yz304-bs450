...
public class ForumTest {
    ...
    public void shouldGetRegisteredUser() {
        ...
        forum.registerUser("John Egan", "captain", "j.egan@erciyes.edu.tr");
    ...
    Forum makeForum() {
        Forum forum = new Forum();
        forum.registerUser("Billy Sharp", "billy", "b.sharp@erciyes.edu.tr");
        forum.registerUser("Iliman NDiaye", "ili", "i.ndiaye@erciyes.edu.tr");
        forum.registerUser("Chris Basham", "bash", "c.basham@erciyes.edu.tr");
        return forum;
    }
